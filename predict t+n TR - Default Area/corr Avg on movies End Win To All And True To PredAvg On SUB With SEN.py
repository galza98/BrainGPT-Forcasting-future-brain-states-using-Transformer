...
# 3) פרמטרים, נתיבים וטעינת מודלים
# ————————————————————————————————————————————————
data_dir         = r"D:\Final Project\Yuval_Gal\Processed_Matrices_Default_Area"
test_dirs_pickle = r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\test_dirs.pickle"
model_paths = [
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+1 - Default Area\predict_TR+1_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+2 Default Area\predict_TR+2_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+3 Default Area\predict_TR+3_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+4 Default Area\predict_TR+4_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+5 Default Area\predict_TR+5_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+6 Default Area\predict_TR+6_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+7 Default Area\predict_TR+7_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+8 Default Area\predict_TR+8_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+9 Default Area\predict_TR+9_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+10 Default Area\predict_TR+10_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+11 Default Area\predict_TR+11_transformer_Default_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - Default Area\pred t+12 Default Area\predict_TR+12_transformer_Default_AREA.pth"
]
window_start = 40
window_size  = 30
...
for h, d, psem, z in zip(horizons_sorted, delta, pooled_sem, z_like):
    print(f"t+{h+1}: Δ={d:.5f}, pooledSEM={psem:.5f}, Δ/pooledSEM={z:.2f}")
...
for h in horizons_sorted:
    ...
    n = min(len(a), len(b))
    if n <= 1:
        print(f"t+{h+1}: not enough samples")
        continue
    a, b = a[:n], b[:n]
    diffs = a - b
    ...
    print(f"t+{h+1}: meanΔ={mean_diff:.5f}, SEMΔ={sem_diff:.5f}, 95% CI=[{ci_low:.5f}, {ci_high:.5f}], p={p_val:.4f}, n={n}")
#
# # ====== ציור עם error bars (mean ± SEM) + מספרים של ה-SEM על הגרף ======
# fig, ax = plt.subplots(figsize=(8, 5))
#
...
# — שם גרף —
ax.set_title("Pred vs True vs Last — Mean Pearson r (±SEM) In Default Area", fontsize=12, pad=10)
