...
test_dirs_pickle = r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\test_dirs.pickle"
model_paths = [
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+1\predict_TR+1_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+2\predict_TR+2_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+3\predict_TR+3_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+4\predict_TR+4_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+5\predict_TR+5_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+6\predict_TR+6_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+7\predict_TR+7_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+8\predict_TR+8_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+9\predict_TR+9_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+10\predict_TR+10_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+11\predict_TR+11_transformer_DorsAttn_AREA.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - DorsAttn_Area\pred t+12\predict_TR+12_transformer_DorsAttn_AREA.pth"
]
window_start = 100
window_size  = 30
...
# — שם גרף —
ax.set_title("Pred vs True vs Last — Mean Pearson r (±SEM) In DorsAttn Area", fontsize=12, pad=10)
