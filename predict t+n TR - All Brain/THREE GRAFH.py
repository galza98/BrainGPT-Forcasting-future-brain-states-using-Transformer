...
data_dir         = r"D:\Final Project\Yuval_Gal\Processed_Matrices"
test_dirs_pickle = r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\test_dirs.pickle"
model_paths = [
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+1\predict_TR+1_transformer_All_Brain.pth",
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+2\predict_TR+2_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+3\predict_TR+3_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+4\predict_TR+4_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+5\predict_TR+5_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+6\predict_TR+6_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+7\predict_TR+7_transformer_All_Brain.pth',
    r'D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+8\predict_TR+8_transformer_All_Brain.pth',
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+9\predict_TR+9_transformer_All_Brain.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+10\predict_TR+10_transformer_All_Brain.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+11\predict_TR+11_transformer_All_Brain.pth",
    r"D:\Final Project\Yuval_Gal\brain_state_pred-main\נסיונות\predict t+n TR - All Brain\pred t+12\predict_TR+12_transformer_All_Brain.pth"
]
...
ax.set_title("Mean Pearson r Across All Subjects - All Brain - Window From Movie End", fontsize=16)
ax.set_xlabel("Horizon (t+…)", fontsize=14)
ax.set_ylabel("Mean Pearson r", fontsize=14)
ax.set_xticks(horizons_sorted)
ax.set_xticklabels([f"t+{h}" for h in horizons_sorted])
